...
class Frame(wx.Frame):
    ...
    def create_header(self, parent):
        ...
        button = controls.BitmapLink(panel, popups.COMMAND_CLOSE, wx.Bitmap('icons/cross.png'),
                                     wx.Bitmap('icons/cross_hover.png'))
    ...
    def create_footer(self, parent):
        ...
        panel.SetBackgroundColour(wx.Colour(*BACKGROUND))
        panel.SetForegroundColour(wx.BLACK)
        first = controls.BitmapLink(panel, popups.COMMAND_FIRST, wx.Bitmap('icons/control_start.png'),
                                    wx.Bitmap('icons/control_start_blue.png'))
        previous = controls.BitmapLink(panel, popups.COMMAND_PREVIOUS, wx.Bitmap('icons/control_rewind.png'),
                                       wx.Bitmap('icons/control_rewind_blue.png'))
        ...
        text.fit_no_wrap()
        next = controls.BitmapLink(panel, popups.COMMAND_NEXT, wx.Bitmap('icons/control_fastforward.png'),
                                   wx.Bitmap('icons/control_fastforward_blue.png'))
        last = controls.BitmapLink(panel, popups.COMMAND_LAST, wx.Bitmap('icons/control_end.png'),
                                   wx.Bitmap('icons/control_end_blue.png'))
        play = controls.BitmapLink(panel, popups.COMMAND_PLAY, wx.Bitmap('icons/control_play.png'),
                                   wx.Bitmap('icons/control_play_blue.png'))
        pause = controls.BitmapLink(panel, popups.COMMAND_PAUSE, wx.Bitmap('icons/control_pause.png'),
                                    wx.Bitmap('icons/control_pause_blue.png'))
